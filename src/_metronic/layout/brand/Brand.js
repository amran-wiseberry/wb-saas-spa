...
class Brand extends React.Component {
  render() {
    const { brandClasses , menuData } = this.props;
    return (
      <div
        ...
        <div className="kt-header__brand-logo">
          <Link to="/">
            <img
              ...
              alt="logo"
              src={toAbsoluteUrl("/media/logos/wiseberry-logo.png")}
            />
            ...
            <Dropdown.Menu className="dropdown-menu-md">
              ...
              menuData.map((menu, index) => (
                ...
                <a className="kt-nav__link active" href="#">
                  ...
                  <span className="kt-nav__link-text">{menu.organisation_name} {menu.role_name}</span>
                </a>
              </li>
              ))}
                {/* <li className="kt-nav__item">
...
const mapStateToProps = store => {
  console.log(store.auth.user.data.userOrganisationRole);
  return {
    menuData: store.auth.user.data.userOrganisationRole,
