            ...
            <div className={`kt-container ${footerContainerClasses}`}>
              <div className="kt-footer__wrapper">
                <div className="kt-footer__logo">
                  <Link to={"/"}>
                    <img alt="Logo" src={toAbsoluteUrl("/media/logos/wiseberry-logo.png")} />
                  </Link>
                  <div className="kt-footer__copyright">
                    {today}&nbsp;&copy;&nbsp;
                    <a href="http://wiseberry.com.au/" target="_blank">Wiseberry Real Estate </a>
                  </div>
                </div>
                <div className="kt-footer__menu">
                  <a href="http://wiseberry.com.au/" target="_blank">Team</a>
                  <a href="http://wiseberry.com.au/" target="_blank">Contact</a>
                </div>
              </div>
            </div>
          </div>
